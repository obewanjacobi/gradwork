...
Hence,
$$m(\lim \sup (E_n)) \leq m(\bigcup^{\infty} _{k=N} E_k) \leq \sum^{\infty} _{k=n} m(E_k) < \epsilon$$
...
$$|\int_A f| \leq |\int_B f - \int_A f| = |\int_{B-A} f| \leq \int_{B-A} |f| < \epsilon$$
...
$$(\int_0 ^1 |f|^2) ^{1/2} = (\frac{1}{3} x^3 |^1 _0)^{1/2} < \infty$$
So $x \in L^2$. Given this, we can see that 
$$||x \cdot f(x)||_1 \leq ||x||_2 ||f||_2$$ by Holders'.
Then,
$$||x||_2 ||f||_2 \leq (\frac{1}{3} x^3 |^1 _0)^{1/2} \cdot 1 \leq \frac{1}{\sqrt{3}}$$
QED
