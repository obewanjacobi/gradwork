...
### Let $K_n$ be a sequence from $L^1(\mathbb{R})$ such that $\{\int_{\mathbb{R}} |K_n|: n \in \mathbb{N}\}$ is bounded, $\int_{\mathbb{R}} K_n \to 1$, and for all $\delta > 0$, $\int_{|x|>\delta}|K_n| \to 0$. If $f:\mathbb{R} \to \mathbb{R}$ is bounded and uniformly continuous, then prove $K_n * f$ uniformly converges to $f$ where $*$ is the convolution.
#### My Solution:
